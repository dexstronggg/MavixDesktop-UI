...
# Фиксируем настоящие ключи ОС ДО того, как dotenv что-либо добавит.
# Только эти ключи будут защищены от перезаписи через Settings UI.
_real_os_keys = frozenset(os.environ.keys())
...
user_config.init(_real_os_keys)
